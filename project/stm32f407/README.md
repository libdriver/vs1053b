...
SCI SPI Pin: SCK/MISO/MOSI/CS  PA5/PA6/PA7/PA4.

SDI SPI Pin: SCK/MISO/MOSI/CS  PA5/PA6/PA7/PA3.

GPIO Pin: RESET/DREQ PA0/PA8.
...
vs1053b: SCI SCK connected to GPIOA PIN5.
vs1053b: SCI MISO connected to GPIOA PIN6.
vs1053b: SCI MOSI connected to GPIOA PIN7.
vs1053b: SCI CS connected to GPIOA PIN4.
vs1053b: SDI SCK connected to GPIOA PIN5.
vs1053b: SDI MISO connected to GPIOA PIN6.
vs1053b: SDI MOSI connected to GPIOA PIN7.
vs1053b: SDI CS connected to GPIOA PIN3.
vs1053b: RESET connected to GPIOA PIN0.
vs1053b: DREQ connected to GPIOA PIN8.
```
...
vs1053b: set treble control 0x0B.
...
vs1053b: set bass enhancement 0x08.
...
vs1053b: set lower limit frequency in 10 hz 0x07.
...
vs1053b: set start address 0x04.
vs1053b: check start address ok.
vs1053b: vs1053b_set_vol/vs1053b_get_vol test.
vs1053b: set vol left 0x6C.
vs1053b: set vol left 0x2B.
...
vs1053b: write application 0 0xBA 0x61.
vs1053b: check application ok.
vs1053b: write application 1 0x65 0xA1.
vs1053b: check application ok.
vs1053b: write application 2 0x72 0x64.
vs1053b: check application ok.
vs1053b: write application 3 0x39 0x3D.
vs1053b: check application ok.
...
vs1053b: gpio input is 0x0B1C.
vs1053b: finish register test.
```

```shell
vs1053b -t play --file=0:we-are-the-world.mp3
...
```shell
vs1053b -t play --file=0:we-are-the-world.aac
...
```shell
vs1053b -t play --file=0:we-are-the-world.flac
...
```shell
vs1053b -t play --file=0:we-are-the-world.ogg
...
```shell
vs1053b -t play --file=0:we-are-the-world.wav
...
```shell
vs1053b -t play --file=0:we-are-the-world.wma
...
```shell
vs1053b -t record --file=0:record.wav --time=60
...
```shell
vs1053b -t record --file=0:record.ogg --time=60
...
```shell
vs1053b -e play --file=0:we-are-the-world.mp3
...
```shell
vs1053b -e record --file=0:record.wav --time=60
...
```shell
vs1053b -e record --file=0:record.ogg --time=60
